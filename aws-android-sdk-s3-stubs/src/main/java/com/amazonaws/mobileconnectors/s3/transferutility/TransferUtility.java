 ...
 * Moreover, the interface AmazonS3 is cut out in favor of using the AmazonS3Client implementation of it directly.
 *
 * Fork History:
...
public class TransferUtility {
    ...
    public static class Builder {
         ...
         * @return builder
         */
        public Builder s3Client(final AmazonS3Client s3Client) {
            this.s3 = s3Client;
            return this;
        }
...
//            }
     ...
     * @param tuOptions     The TransferUtility Options object
     */
    private TransferUtility(AmazonS3Client s3, Context context, String defaultBucket,
...
//        TransferThreadPool.init(this.transferUtilityOptions.getTransferThreadPoolSize());
     ...
     */
    @Deprecated
    public TransferUtility(AmazonS3Client s3, Context context) {
        this.s3 = s3;
...
//        TransferThreadPool.init(this.transferUtilityOptions.getTransferThreadPoolSize());
     ...
     * @return A TransferObserver used to track upload progress and state
     */
    public TransferObserver upload(String bucket, String key, File file, ObjectMetadata metadata, TransferListener listener) {
        if (file == null || file.isDirectory() || !file.exists()) {
            throw new IllegalArgumentException("Invalid file: " + file);
        }

        // TODO: Re-add the deteremination of single vs multi-part upload if needed for testing.
        ...
        TransferObserver transferObserver = new TransferObserver(recordId, bucket, key, file, listener);
        // cognoamod_begin
...
//        }
    ...
    public boolean deleteTransferRecord(int id) {
        cancel(id);
        return true; // TODO: Configure as we need.
